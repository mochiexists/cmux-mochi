...
GHOSTTYKIT_RELEASE_REPO="${GHOSTTYKIT_RELEASE_REPO:-mochiexists/ghostty}"
...
DOWNLOAD_URL="${GHOSTTYKIT_URL:-https://github.com/$GHOSTTYKIT_RELEASE_REPO/releases/download/$TAG/$ARCHIVE_NAME}"
