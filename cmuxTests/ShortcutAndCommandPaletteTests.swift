...
final class BuildFlavorTests: XCTestCase {
    func testDetectsDevFromBundleName() {
        XCTAssertEqual(
            BuildFlavor.detect(bundleName: "cmux Mochi DEV noqdlg", bundleIdentifier: "com.cmux-mochi"),
            .dev
        )
    }
    ...
    func testDetectsDevBeforeTagTextCanLookNightly() {
        XCTAssertEqual(
            BuildFlavor.detect(bundleName: "cmux Mochi DEV nightly", bundleIdentifier: "com.cmux-mochi"),
            .dev
        )
    }
    ...
    func testDetectsNightlyFromBundleIdentifier() {
        XCTAssertEqual(
            BuildFlavor.detect(bundleName: "cmux Mochi", bundleIdentifier: "com.cmux-mochi.nightly"),
            .nightly
        )
    }
    ...
    func testDetectsStableByDefault() {
        XCTAssertEqual(
            BuildFlavor.detect(bundleName: "cmux Mochi", bundleIdentifier: "com.cmux-mochi"),
            .stable
        )
    }
}
