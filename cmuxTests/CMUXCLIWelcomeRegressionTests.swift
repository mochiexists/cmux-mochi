...
struct CMUXCLIWelcomeRegressionTests {
    ...
    @Test func welcomePublishesAuditedForkFeatureCatalog() throws {
        ...
        for expected in [
            ...
            "actionable Tailscale guidance",
            "visible pairing/reconnect progress",
            "Resource Monitor",
            "full-area Task Manager",
            "surface-pinned send/submit/wait",
            "Artifact panes",
            "adaptive right-side pane placement",
            "highlighted and immediately drop-ready sidebar targets",
            "Shift-select to drag multiple tabs together",
            "Privacy Frost",
