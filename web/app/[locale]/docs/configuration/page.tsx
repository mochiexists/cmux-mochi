...
const schemaUrl =
  ...
  "https://raw.githubusercontent.com/mochiexists/cmux-mochi/main/web/data/cmux.schema.json";
const schemaSourceUrl =
  "https://github.com/mochiexists/cmux-mochi/blob/main/web/data/cmux.schema.json";
const sectionOrder = [
  "app",
  "terminal",
  "notifications",
