...
```bash
cd ghostty
git remote -v  # origin = upstream, mochi = fork
git checkout -b <branch>
git add <files>
git commit -m "..."
git push mochi <branch>
```
