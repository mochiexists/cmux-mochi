...
enum FileExternalOpenAction {
    ...
    /// Reveals a path that may be a directory, selecting the item inside its
...
@MainActor
final class FilePreviewPanel: Panel, ObservableObject, FilePreviewTextEditingPanel, FileBackedPanel {
    let id: UUID
