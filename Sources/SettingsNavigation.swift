...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.terminal, "agent-auto-resume", String(localized: "settings.terminal.agentResumeMode", defaultValue: "Agent Resume on Reopen"), "terminal.agentResumeMode terminal.autoResumeAgentSessions auto resume restore reopen relaunch quit sessions agents claude code codex opencode rovo dev rovodev off medium full scrollback prefill toggle"),
        ...
        setting(.terminal, "scrollback-autosave", String(localized: "settings.terminal.autosaveScrollback", defaultValue: "Autosave Terminal Scrollback"), "terminal.autosaveScrollback crash force quit hard kill scrollback snapshot autosave recovery"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "terminal.agentResumeMode": settingID(for: .terminal, idSuffix: "agent-auto-resume"),
        ...
        "terminal.autosaveScrollback": settingID(for: .terminal, idSuffix: "scrollback-autosave"),
