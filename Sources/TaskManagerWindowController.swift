...
/// ephemeral: they are deliberately not persisted across launches (see the
/// `.taskManager` arm of `Workspace`'s session snapshot builder, which returns
/// nil like the other ephemeral panels).
@MainActor
