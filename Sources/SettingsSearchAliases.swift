enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "terminal:scrollback-autosave": localized("settings.search.alias.setting.terminal.scrollback-autosave", defaultValue: "terminal.autosaveScrollback crash force quit hard kill autosave scrollback snapshots recovery restore"),
