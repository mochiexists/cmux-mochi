...
enum StartupBreadcrumbLog {
    ...
    private nonisolated static let logger = Logger(subsystem: "com.cmux-mochi", category: "StartupBreadcrumbLog")
    ...
    private static var isEnabled: Bool {
        ...
        return bundleIdentifier == "com.cmux-mochi.nightly"
            || bundleIdentifier.hasPrefix("com.cmux-mochi.nightly.")
