...
@Suite struct IOSBuildScopedPairedMacStoreTests {
    ...
    @Test func currentScopePrefersInstalledBundleSuffix() {
        #expect(MobileIOSBuildScope.current(infoDictionary: ["CMUXDevTag": "feat"], bundleIdentifier: "com.cmux-mochi.ios.other")?.value == "other")
        #expect(MobileIOSBuildScope.current(infoDictionary: ["CMUXDevTag": ""], bundleIdentifier: "com.cmux-mochi.ios.agent")?.value == "agent")
