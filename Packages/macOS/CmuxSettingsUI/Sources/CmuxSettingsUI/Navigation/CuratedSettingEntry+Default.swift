    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(
                ...
                title: String(localized: "settings.terminal.agentResumeMode", defaultValue: "Agent Resume on Reopen"),
                synonyms: "terminal.agentResumeMode terminal.autoResumeAgentSessions auto resume restore reopen relaunch quit sessions agents claude code codex opencode rovo dev rovodev off medium full scrollback prefill toggle"
            ),
