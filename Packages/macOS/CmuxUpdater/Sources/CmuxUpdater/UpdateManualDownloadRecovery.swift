...
public struct UpdateManualDownloadRecovery: Sendable {
    ...
    public init(
        stableDownloadURLString: String = "https://github.com/mochiexists/cmux-mochi/releases/latest/download/cmux-macos.dmg",
        nightlyDownloadURLString: String = "https://github.com/mochiexists/cmux-mochi/releases/download/nightly/cmux-nightly-macos.dmg"
    ) {
